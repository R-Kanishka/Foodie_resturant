                        ...
                        <tbody>
                          <%
                            ...
                            try {
                                ...
                                conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/foodiesdata", "root", "res22537");
                          ...
                          %>
                          <tr>
                            <td style="text-align:center"><%= rs.getString("item_name") %></td>
                            <td style="text-align:center"><%= rs.getString("price") %></td>
                            <td style="text-align:center"><img src="<%= rs.getString("image") %>" style="width: 100px; height: 100px;" /></td>
