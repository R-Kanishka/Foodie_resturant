  ...
  <section class="food_section layout_padding">
    <div class="container">
      <div class="heading_container heading_center">
        <section class="bg-primary py-3 py-md-5 py-xl-8 d-flex justify-content-center align-items-center" style="min-height: 100vh;">
            <div class="container">
              <div class="row gy-4 align-items-center justify-content-center">
                <div class="col-12 col-md-6 col-xl-5">
                  <div class="card border-0 rounded-4">
                    <div class="card-body p-6 p-md-8 p-xl-10">
                      <div class="row">
                        <div class="col-12">
                          <div class="mb-4">
                            <h5 class="fs-6 fw-normal text-primary m-0">Login</h5>
                          </div>
                        </div>
                      </div>
