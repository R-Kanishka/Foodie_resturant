...
<%@ page import="dao.BookTableDao" %>
<%@ page import="model.BookTable" %>
            ...
            <div class="col-md-9">
              <nav aria-label="breadcrumb" style="color:red;">
                <ol class="breadcrumb pl-0">
                  ...
                  <li class="breadcrumb-item"><a>Table Reserverd</a></li>
                      ...
                      <table id="myTable" class="table table-striped table-bordered">
                        ...
                        <tbody>
                           <%
                      			...
                      			List<BookTable> bookings = bookTableDao.getAllBookings();
                      				for (BookTable booking : bookings) {
                   		 %>
                      <tr>
                        <td style="text-align:center"><%= booking.getName() %></td>
                        <td style="text-align:center"><%= booking.getPhoneNumber() %></td>
                        <td style="text-align:center"><%= booking.getEmail() %></td>
                        <td style="text-align:center"><%= booking.getCount() %></td>
                        <td style="text-align:center"><%= booking.getDate() %></td>
                        <td style="text-align:center">
                          <a href="table.reserverd.form.jsp?id=<%= booking.getId() %>" class="btn btn-success">View</a>
                        </td>
                      </tr>
                    <% } %>
                        </tbody>
